...
export default function MaterialsPage() {
  ...
  const handleOpenFlashcards = async (material: Material) => {
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-3 pt-3 border-t border-border/60">
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 text-xs bg-accent/10 hover:bg-accent text-accent hover:text-accent-foreground font-medium px-3 py-1.5 rounded-md transition-colors cursor-pointer"
                      >
                        <Sparkles size={13} />
            ...
            {generatingCards ? (
              <div className="py-16 flex flex-col items-center justify-center text-center gap-3">
                ...
                <p className="text-sm font-medium text-foreground">
                  Synthesizing Flashcards with Groq AI...
                </p>
                <p className="text-xs text-muted-foreground">
                  Extracting core concepts and formulation questions
                </p>
              </div>
            ) : flashcards.length > 0 ? (
